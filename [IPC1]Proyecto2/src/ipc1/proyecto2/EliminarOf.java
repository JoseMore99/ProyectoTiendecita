 ...
 * @author Moreira Paz
 */
public class EliminarOf extends javax.swing.JFrame {

    /**
     * Creates new form EliminarOf
     */
    public EliminarOf() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminar Primera Oferta:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarOf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarOf().setVisible(true);
            }
        });
    }
